...
<template>
    <div style="background-color: #F4F1EA;" class=" pt-20 pb-10 xl:px-40 ">
        <div style="background-color: white;" class="rounded-[20px]  ">
            ...
            <div class="flex justify-around px-42 pb-10 flex-wrap 2xl:flex hidden">
                <div v-for="(item, index) in 4" class="cursor-pointer mt-5">
