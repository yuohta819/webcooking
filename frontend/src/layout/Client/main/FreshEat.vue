            ...
            <div >
                ...
                <div class="pt-10 pb-30 relative ">
                    <button class="px-5 py-3">
                        ...
                        <div class="box-1"></div>
                        <div class="box-2"></div>
                        <i style="background-color: white; color: red;"
                            class="p-1 ml-4 fa-solid fa-arrow-right z-10"></i>
                    </button>
                </div>
            </div>
            <div class="icon3 absolute top-28 right-32 2xl:block hidden">
                <img src="https://www.ex-coders.com/php-template/fresheat/assets/img/cta/ctaThumb1_1.png" alt=""
                    width="650">
            </div>
        </div>
