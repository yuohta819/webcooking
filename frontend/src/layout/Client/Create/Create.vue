...
<template>
  <div class="img-2">
    <div class="text-center py-40">
      <div style="color: white; text-transform: uppercase;" class="text-[80px] font-black mb-3">Add Products</div>
      <div style="color: white; " class="font-bold">Home <span class="ml-3">/</span> <span class="ml-3 font-bold"
          style="color: red;">Add Products</span></div>
    </div>
  </div>
  <div class="bg-[white] p-6 max-w-6xl mx-auto my-20" style="background-color: white;">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div>
        ...
        <input class="w-full p-2 border rounded mb-4" @input="handleName($event.target.value)" placeholder="Name: " />
        <input class="w-full p-2 border rounded mb-4" @input="handleDescribe($event.target.value)"
          placeholder="Describe: " />
        <input class="w-full p-2 border rounded mb-4" @input="handlePrice($event.target.value)" placeholder="Price: " />
