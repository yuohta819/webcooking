...
async function handleSubmit() {
    const response = await axios.get('http://localhost:8080/account/check', {
        params: {
                ...
                <div class="px-10 w-145 rounded-[20px]" style="background-color: #F4F1EA;">
                    ...
                    <div class="my-5  relative" @click="handleSubmit">
                        <div class="py-3 text-center button  rounded-[50px] flex items-center justify-around px-39"
                            ...
                            <div class="font-bold text-[14px] relative z-3 "> Login
                            </div>
                            <div class="box-1 "></div>
                            <div class="box-2"></div>
                        </div>
                    ...
                    <div class="my-10 text-center"><span>Don’t have an account? </span><span
                            style="color: #EB0029;;"><a href="/register">Sign Up</a></span></div>
                </div>
