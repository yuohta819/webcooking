...
async function handleSubmit() {
    const response = await axios.get('http://localhost:8080/account/save', {
        params: {
    ...
    <div class="img-2">
        <div class="text-center py-40">
            ...
            <div style="color: white; " class="font-bold">Home <span class="ml-3">/</span> <span class="ml-3 font-bold"
                    style="color: red;">My Account</span></div>
        </div>
    </div>
        ...
        <div style="background-color: white;" class=" py-7 rounded-[15px]">
            <div class="flex justify-between lg:mx-10">
                <div class="px-10 w-145 rounded-[20px]" style="background-color: #F4F1EA;">
                    ...
                    <div class="mt-10 ">
                        <input class="py-5 pl-3" type="text" @input="handleName($event.target.value)"
                            placeholder="Name" style="width: 100%; background: white;">
                    </div>
                    <div class="mt-5 ">
                        <input class="py-5 pl-3" type="text" @input="handleAccount($event.target.value)"
                            placeholder="Email" style="width: 100%; background: white;">
                    </div>
                    <div class="mt-5 ">
                    ...
                    <div class="text-end mt-5 font-medium" style="color: #EB0029;">
                        Forgot Password?
                    </div>
                    <div class="flex items-center">
                        <div class="ml-2"><input style="transform: scale(1.6);" type="checkbox"></div>
                    ...
                    <div class="my-10 text-center"><span>Don’t have an account? </span><span
                            style="color: #EB0029;;"><a href="/account">Login</a></span></div>
                </div>
